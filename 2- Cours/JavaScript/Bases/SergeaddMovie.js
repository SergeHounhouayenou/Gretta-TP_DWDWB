document.addEventListener ("DOMContentLoaded", ()=> 
    {
        ...
        function storeMovieInLocalStorage(movie)
                                                {
                                                    // Récupérer les films  du localstorage (si présent)
                                                    const storeData = localStorage.getItem('movies') ;
                                                    const movies = storeData ? JSON.parse(storeData) : [] ;// opérateur ternaire. Si c'est vide (si la valeur n'existe pas) alors tu mets un tableau vide 
                                                    movies.push(movie) ;
